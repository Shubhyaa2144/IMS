...
class IMS:
    def __init__(self,root):
        ...
        #===footer====
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed By Shubham\nFor any Tecnhical Issue Contact: 9699384019",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#==========================================================================================================
    ...
    def update_contect(self):
        ...
        try:
            ...
            self.lbl_clock.after(200,self.update_contect)
