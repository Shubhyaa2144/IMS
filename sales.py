...
class salesClass:
    def __init__(self, root):
        ...
        #==============================title======================================
        lbl_title=Label(self.root,text="View Customer Bills",font=("goudy old style",30),bg="#184a85",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        clear_search=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15),bg="lightgray",cursor="hand2").place(x=490,y=100,width=120,height=28)
        #===== Bill List====
        ...
        lbl_title2=Label(bill_Frame,text="View Customer Bills Area",font=("goudy old style",20),bg="orange").pack(side=TOP,fill=X)
