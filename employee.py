...
class employeeClass:
    def __init__(self, root):
        ...
        cmd_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Email","Name","Contact"),state='readonly',justify=CENTER,font=("goudy oid style",15))
        ...
        #====title====
        title=Label(self.root,text="Employee Detalis",font=("goudy old style",15),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1000)
        ...
        cmd_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Other"),state='readonly',justify=CENTER,font=("goudy oid style",15))
        ...
        cmd_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee"),state='readonly',justify=CENTER,font=("goudy oid style",15))
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","gender","contact","name","dob","doj","email","pass","utype","address","salary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.EmployeeTable.heading("pass",text="Pasword")
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                if row!=None:
                    ...
                    cur.execute("INSERT INTO employee (eid,  gender, contact, name,  dob, doj, email, pass, utype, address, salary) values(?,?,?,?,?,?,?,?,?,?,?)", (
                                             self.var_emp_id.get(),
                                             self.var_gender.get(),
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                if row==None:
                    ...
                    cur.execute("Update employee set gender=?,contact=?,name=?,dob=?,doj=?,email=?,pass=?,utype=?,address=?,salary=? where eid=?",(
